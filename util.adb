M:util
F:G$reset_wdt$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$config_tc0$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$delay_ms$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$delay_us$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ISR_TC0$0$0({2}DF,SV:S),Z,0,0,1,1,0
T:Futil$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:Futil$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$tempo_us$0$0({2}SI:U),E,0,0
S:Lutil.delay_ms$t$1$14({2}SI:U),R,0,0,[]
