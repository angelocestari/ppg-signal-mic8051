M:eeprom
F:G$send_start$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$send_stop$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$esc_byte_cntr$0$0({2}DF,SC:U),C,0,0,0,0,0
F:G$esc_byte_dado$0$0({2}DF,SC:U),C,0,0,0,0,0
F:G$le_eeprom$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$esc_eeprom$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$guarda_eeprom$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ISR_TC4$0$0({2}DF,SV:S),Z,0,0,1,16,0
T:Feeprom$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:Feeprom$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$tempo_us$0$0({2}SI:U),E,0,0
S:G$eeprom_idx$0$0({1}SC:U),E,0,0
S:Leeprom.esc_byte_cntr$slave_addr$1$19({1}SC:U),R,0,0,[r7]
S:Leeprom.esc_byte_dado$dado$1$22({1}SC:U),R,0,0,[]
S:Leeprom.le_eeprom$endereco$1$25({1}SC:U),R,0,0,[r7]
S:Leeprom.le_eeprom$dado$1$26({2}SI:S),R,0,0,[r6,r7]
S:Leeprom.le_eeprom$status$1$26({1}SC:U),R,0,0,[r6]
S:Leeprom.esc_eeprom$dado$1$29({1}SC:U),E,0,0
S:Leeprom.esc_eeprom$endereco$1$29({1}SC:U),R,0,0,[r7]
S:Leeprom.esc_eeprom$status$1$30({1}SC:U),R,0,0,[r6]
S:Leeprom.guarda_eeprom$amostra$1$32({2}SI:U),R,0,0,[r6,r7]
S:Leeprom.send_start$first$1$13({1}SB0$1:U),H,0,0
S:Leeprom.esc_byte_cntr$RW$1$19({1}SB0$1:U),H,0,0
S:Leeprom.esc_byte_dado$sloc0$1$0({1}SB0$0:S),H,0,0
...
S:G$send_start$0$0({2}DF,SV:S),C,0,0
S:G$send_stop$0$0({2}DF,SV:S),C,0,0
S:G$esc_byte_cntr$0$0({2}DF,SC:U),C,0,0
S:G$esc_byte_dado$0$0({2}DF,SC:U),C,0,0
