M:adc
F:G$config_adc0$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$le_adc0$0$0({2}DF,SI:U),Z,0,0,0,0,0
F:G$ISR_ADC0$0$0({2}DF,SV:S),Z,0,0,1,15,0
T:Fadc$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:Fadc$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$tempo_us$0$0({2}SI:U),E,0,0
S:G$nova_amostra$0$0({2}SI:U),E,0,0
S:Ladc.config_adc0$ganho$1$12({1}SC:U),E,0,0
S:Ladc.config_adc0$canal$1$12({1}SC:U),R,0,0,[r7]
