...
F:G$esc_glcd$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$conf_Y$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$conf_pag$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$limpa_glcd$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$init_GLCD$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$putchar$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$putchar$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$limpa_col_glcd$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$escala_glcd$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$ponto_glcd$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:Lglcd.esc_glcd$dado$1$55({1}SC:U),R,0,0,[r7]
S:Lglcd.esc_glcd$status$1$56({1}SC:U),R,0,0,[]
S:Lglcd.conf_Y$y$1$58({1}SC:U),R,0,0,[r7]
S:Lglcd.conf_pag$pag$1$60({1}SC:U),R,0,0,[r7]
S:Lglcd.limpa_glcd$pag$1$63({1}SC:U),R,0,0,[r7]
S:Lglcd.limpa_glcd$hor$1$63({1}SC:U),R,0,0,[r6]
S:Lglcd.putchar$coluna$1$71({1}SC:U),E,0,0
S:Lglcd.putchar$c$1$70({1}SC:U),R,0,0,[r7]
S:Lglcd.putchar$lado$1$71({1}SC:U),R,0,0,[r6]
S:Lglcd.limpa_col_glcd$hor$1$74({1}SC:U),R,0,0,[r7]
S:Lglcd.limpa_col_glcd$pag$1$75({1}SC:U),R,0,0,[r5]
S:Lglcd.limpa_col_glcd$lado$1$75({1}SC:U),R,0,0,[r6]
S:Lglcd.escala_glcd$lim_inf$1$77({4}SF:S),E,0,0
S:Lglcd.escala_glcd$lim_sup$1$77({4}SF:S),E,0,0
S:Lglcd.escala_glcd$valor$1$77({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:Lglcd.escala_glcd$ajustado$1$78({4}SF:S),R,0,0,[r4,r5,r6,r7]
S:Lglcd.ponto_glcd$ver$1$79({1}SC:U),E,0,0
S:Lglcd.ponto_glcd$hor$1$79({1}SC:U),R,0,0,[r7]
S:Lglcd.ponto_glcd$lado$1$80({1}SC:U),R,0,0,[r6]
S:Lglcd.ponto_glcd$bitv$1$80({1}SC:U),R,0,0,[r5]
S:Lglcd.ponto_glcd$pag$1$80({1}SC:U),R,0,0,[]
S:Lglcd.le_glcd$cd$1$53({1}SB0$1:U),H,0,0
S:Lglcd.le_glcd$cs$1$53({1}SB0$1:U),H,0,0
S:Lglcd.esc_glcd$cd$1$55({1}SB0$1:U),H,0,0
S:Lglcd.esc_glcd$cs$1$55({1}SB0$1:U),H,0,0
S:Lglcd.conf_Y$cs$1$58({1}SB0$1:U),H,0,0
S:Lglcd.conf_pag$cs$1$60({1}SB0$1:U),H,0,0
S:Lglcd.putchar$sloc0$1$0({1}SB0$1:U),H,0,0
S:Lglcd.limpa_col_glcd$sloc0$1$0({1}SB0$1:U),H,0,0
S:Lglcd.escala_glcd$sloc0$1$0({1}SB0$0:S),H,0,0
S:Lglcd.ponto_glcd$sloc0$1$0({1}SB0$1:U),H,0,0
