M:filtro
F:G$guarda_buffer$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$limites_amostras$0$0({2}DF,SV:S),Z,0,0,0,0,0
T:Ffiltro$UU32[({0}S:S$U32$0$0({4}SL:U),Z,0,0)({0}S:S$S32$0$0({4}SL:S),Z,0,0)({0}S:S$UU16$0$0({4}DA2d,STUU16:S),Z,0,0)({0}S:S$U16$0$0({4}DA2d,SI:U),Z,0,0)({0}S:S$S16$0$0({4}DA2d,SI:S),Z,0,0)({0}S:S$U8$0$0({4}DA4d,SC:U),Z,0,0)({0}S:S$S8$0$0({4}DA4d,SC:S),Z,0,0)]
T:Ffiltro$UU16[({0}S:S$U16$0$0({2}SI:U),Z,0,0)({0}S:S$S16$0$0({2}SI:S),Z,0,0)({0}S:S$U8$0$0({2}DA2d,SC:U),Z,0,0)({0}S:S$S8$0$0({2}DA2d,SC:S),Z,0,0)]
S:G$buffer_idx$0$0({1}SC:U),E,0,0
S:G$signal_sum$0$0({4}SF:S),E,0,0
S:Lfiltro.guarda_buffer$amostra$1$8({2}SI:U),R,0,0,[r6,r7]
S:Lfiltro.guarda_buffer$sloc0$1$0({2}DX,SF:S),E,0,0
S:Lfiltro.limites_amostras$min$1$10({3}DG,SF:S),E,0,0
S:Lfiltro.limites_amostras$max$1$10({3}DG,SF:S),E,0,0
S:Lfiltro.limites_amostras$n_prox$1$10({1}SC:U),R,0,0,[r7]
S:Lfiltro.limites_amostras$ini_idx$1$11({1}SC:U),R,0,0,[r6]
S:Lfiltro.limites_amostras$i$1$11({1}SC:U),R,0,0,[]
S:Lfiltro.limites_amostras$amostra$1$11({4}SF:S),E,0,0
S:Lfiltro.limites_amostras$sloc0$1$0({3}DG,SF:S),E,0,0
S:Lfiltro.limites_amostras$sloc1$1$0({3}DG,SF:S),E,0,0
S:G$buffer$0$0({1024}DA256d,SF:S),F,0,0
...
S:Ffiltro$__xinit_buffer$0$0({1024}DA256d,SF:S),C,0,0
